...
/// [`ClientConfig::max_connection_idle`](struct.ClientConfig.
/// html#max_connection_idle.v)
...
/// [`ClientConfig::request_timeout`](struct.ClientConfig.html#request_timeout.
/// v)
...
/// [`ClientConfig::metadata_max_age`](struct.ClientConfig.
/// html#metadata_max_age.v)
...
/// The default time to wait before attempting to retry a failed request to a
...
pub struct ClientConfig {
    ...
    pub broker_version_fallback: Option<KafkaVersion>,
...
impl Default for ClientConfig {
    fn default() -> Self {
        ClientConfig {
            ...
            broker_version_fallback: Some(KafkaVersion::KAFKA_0_9_0),
